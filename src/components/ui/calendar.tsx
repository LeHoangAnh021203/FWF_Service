...
type DayPickerRootProps = React.ComponentProps<'div'> & {
  rootRef?: React.Ref<HTMLDivElement>
}

type DayPickerChevronProps = React.SVGProps<SVGSVGElement> & {
  orientation?: 'left' | 'right' | 'down'
}

type WeekNumberProps = React.ComponentProps<'td'> & {
...
function Calendar({
  ...
  const mergedClassNames = {
    ...
    range_start: cn('rounded-l-md bg-accent', defaultClassNames.range_start, classNames?.range_start),
  ...
  const mergedComponents = {
    Root: ({ className, rootRef, ...props }: DayPickerRootProps) => (
      <div data-slot="calendar" ref={rootRef} className={cn(className)} {...props} />
    ),
    Chevron: ({ className, orientation, ...props }: DayPickerChevronProps) => {
      if (orientation === 'left') {
  ...
  return (
    <DayPicker
      ...
      formatters={mergedFormatters as React.ComponentProps<typeof DayPicker>['formatters']}
